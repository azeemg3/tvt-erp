                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <select class="form-control form-control-sm select2" id="ledger" name="ledger">
                            ...
                            <div class="card card-primary card-outline card-outline-tabs">
                                ...
                                <div class="card-body">
                                    <div class="tab-content" id="custom-tabs-one-tabContent">
                                        <?php echo $__env->make('sales.tours.ticket', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <?php echo $__env->make('sales.tours.hotel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <?php echo $__env->make('sales.tours.visa', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <?php echo $__env->make('sales.tours.transport', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <?php echo $__env->make('sales.tours.other', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
                                </div>
                                <!-- /.card -->
                            </div>
