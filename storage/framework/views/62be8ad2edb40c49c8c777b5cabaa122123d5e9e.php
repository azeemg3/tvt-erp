...
<?php $__env->startSection('content'); ?>
    ...
    <!-- /.content-wrapper -->
    <?php echo $__env->make('providors.visa.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        ...
        function save_rec() {
            $("#loader").show();
            $.ajax({
                url:"<?php echo e(route('visa_providor.store')); ?>",
        ...
        function get_data(page){
            $("#loader").show();
            $.ajax({
                url:"<?php echo e(route('visa_providor.index')); ?>?page="+page,
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                type:"GET",
                dataType:"JSON",
