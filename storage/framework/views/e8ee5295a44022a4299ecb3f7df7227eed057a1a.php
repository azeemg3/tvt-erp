                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="text" name="adult['net_sale']" class="form-control form-control-sm net_sale" placeholder="Net Cost" readonly>
                        </div>
                    </div>
                    <!--row-->
                    <kbd>Child</kbd>
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            <input type="text" name="child['net_sale']" class="form-control form-control-sm net_sale" placeholder="Net Cost" readonly>
                        </div>
                    </div>
                    <!--row-->
                    <kbd>Infant</kbd>
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            <input type="text" name="infant['net_sale']" class="form-control form-control-sm net_sale" placeholder="Net Cost" readonly>
                        </div>
                    </div>
                    <!--row-->
                    <!-- Modal footer -->
...
</div><?php /**PATH E:\new-projects\htdocs\uotrips\resources\views/providors/visa/modal.blade.php ENDPATH**/ ?>