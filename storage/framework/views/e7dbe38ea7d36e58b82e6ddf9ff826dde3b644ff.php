...
<?php $__env->startSection('content'); ?>
    ...
    <!-- /.content-wrapper -->
    <?php echo $__env->make('agents.go.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        ...
        function get_data(page){
            $("#loader").show();
            $.ajax({
                url:"<?php echo e(url('agent_management/get_go')); ?>?page="+page,
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                type:"POST",
                dataType:"JSON",
                success:function (data) {
                    ...
                    for(i in data.data){
                        ...
                        htmlData+='<td>'+data.data[i].agent_code+'</td>';
        ...
        function edit(id) {
            $("#new").modal();
            $.ajax({
                url: "<?php echo e(url('agent_management/go')); ?>/" + id + "/edit",
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                success: function (data) {
