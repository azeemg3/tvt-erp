                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Code</label>
                                <input type="text" name="code" value="<?php echo e($code); ?>" class="form-control form-control-sm" placeholder="e,g 012">
                            </div>
                        </div>
                        <!--col-->
...
</div><?php /**PATH E:\new-projects\htdocs\uotrips\resources\views/Accounts/trans_accounts/modal.blade.php ENDPATH**/ ?>