<script>
    ...
    function hotel_brn(GID) {
        ...
        $.ajax({
            url: "<?php echo e(url('umrah/edit_hotelBrn')); ?>/"+GID,
    ...
    function save_hotel_brn() {
        $.ajax({
            url:"<?php echo e(url('umrah/save_hotelbrn')); ?>",
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type:"POST",
            dataType:"JSON",
    ...
    function transport_brn(GID) {
        ...
        $.ajax({
            url: "<?php echo e(url('umrah/edit_transportBrn')); ?>/"+GID,
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            success: function (data) {
    ...
    function save_transport_brn(g) {
        $.ajax({
            url:"<?php echo e(url('umrah/save_transportbrn')); ?>",
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type:"POST",
            dataType:"JSON",
    ...
    function save_hotel_res_brn() {
        $.ajax({
            url:"<?php echo e(route('hotel_reservation.store')); ?>",
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type:"POST",
            dataType:"JSON",
    ...
    function add_gs(GID) {
        ...
        $.ajax({
            url: "<?php echo e(url('umrah/edit_gground_service')); ?>/"+GID,
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            success: function (data) {
//                $(".more-hotel-brn").html(data.hotelBrn);
    ...
    function save_gs() {
        $.ajax({
            url:"<?php echo e(url('umrah/save_group_det_service')); ?>",
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type:"POST",
            dataType:"JSON",
    ...
    function save_new_gs_det() {
        $.ajax({
            url:"<?php echo e(route('ground_services.store')); ?>",
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type:"POST",
            dataType:"JSON",
    ...
    function more_hotel_brn() {
        ...
        <select name="HTBRN[]" class="form-control form-control-sm select2" onchange="hotel_reservation(this), available_hotel_capacity(this)">\
            ...
            <?php echo App\Models\Umrah\HotelReservationBrn::dropdown(); ?>\
        </select>\
        </div>\
        </div>\
        <!--col-->\
    ...
    function save_rec() {
        $("#loader").show();
        $.ajax({
            url:"<?php echo e(route('group_details.store')); ?>",
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type:"POST",
            dataType:"JSON",
            data:$("#form").serialize(),
    ...
    function get_data(page){
        $("#loader").show();
        $.ajax({
            url:"<?php echo e(url('umrah/get_group_details')); ?>?page="+page,
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type:"POST",
            dataType:"JSON",
    ...
    function edit(id) {
        $("#new").modal();
        $.ajax({
            url: "<?php echo e(url('umrah/group_details')); ?>/" + id + "/edit",
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            success: function (data) {
    ...
    $('#visitor-form').submit(function (e) {
        ...
        $.ajax({
            url: "<?php echo e(url('umrah/save_visitor')); ?>",
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type: "POST",
            dataType: "JSON",
            data: formData,
    ...
    function get_visitor_data(GID) {
        $.ajax({
            url:"<?php echo e(url('umrah/get_visitor_data')); ?>",
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type:"POST",
            dataType:"JSON",
            data:{'GID':GID},
            success:function (data) {
                ...
                for(i in data){
                    ...
                    htmlData += ' <a  class="btn btn-danger btn-xs" href="javascript:void(0)" onclick="del_visitor(\'' + data[i].id + '\', \'<?php echo e(url('umrah/remove_visitor')); ?>/' + data[i].id + '\')"><i class="fa fa-trash"></i> </a>';
                    htmlData += '</td>';
                    htmlData+='</tr>';
                }
    ...
    function edit_pax(id) {
        $.ajax({
            url: "<?php echo e(url('umrah/edit_pax')); ?>/"+id,
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            success: function (data) {
                for (i=0; i<Object.keys(data).length; i++){
...
//                $(".visa_cost").val(window.btoa(data.visa_cost));
    ...
    $(document).on("click", ".save_mofa",function () {
        ...
        var g=$(this);
        $.ajax({
            url: "<?php echo e(url('umrah/save_mofa_details')); ?>",
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type: "POST",
            dataType: "JSON",
            data: dataimg,
    ...
    function add_voucher_amount(g) {
        ...
        $.ajax({
            url:"<?php echo e(url('umrah/edit_gv/')); ?>/"+g,
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type:"GET",
            dataType:"JSON",
            success:function (data) {
...
//            </tr>');
    ...
    function save_group_voucher() {
        $.ajax({
            url:"<?php echo e(url('umrah/save_group_voucher')); ?>",
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type:"POST",
            dataType:"JSON",
        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                for(i in data){
                    ...
                    htmlData += '<td>';
                    htmlData += '<a  class="btn btn-primary btn-xs" href="javascript:void(0)" onclick="edit_pax(\'' + data[i].id + '\')"><i class="fa fa-edit"></i> </a>';
                    htmlData += ' <a  class="btn btn-danger btn-xs" href="javascript:void(0)" onclick="del_rec(\'' + data[i].id + '\', \'<?php echo e(url('crm/save_umrah_pax/remove')); ?>/' + data[i].passport + '\')"><i class="fa fa-trash"></i> </a>';
                    htmlData += '</td>';
                    htmlData+='</tr>';
                }
    ...
    function save_city() {
        $.ajax({
            url:"<?php echo e(route('cities.store')); ?>",
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type:"POST",
            dataType:"JSON",
    ...
    $('#excel-form').submit(function (e) {
        ...
        var formData = new FormData(this);
        $.ajax({
            url: "<?php echo e(url('umrah/save_group_excel')); ?>",
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type: "POST",
            dataType: "JSON",
            data: formData,
    ...
    function save_agent() {
        $("#loader").show();
        $.ajax({
            url:"<?php echo e(route('subadmin.store')); ?>",
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type:"POST",
            dataType:"JSON",
    ...
    $('#upload-visitor').submit(function (e) {
        ...
        var formData = new FormData(this);
        $.ajax({
            url: "<?php echo e(url('umrah/save_visitor_excel')); ?>",
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type: "POST",
            dataType: "JSON",
            data: formData,
    ...
    function available_capacity(g) {
        brn=$(g).val();
        $.ajax({
            url: "<?php echo e(url('umrah/fetch_available_capacity')); ?>/"+brn,
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type: "GET",
            dataType: "JSON",
            success: function (data) {
    ...
    function available_hotel_capacity(g) {
        brn=$(g).val();
        $.ajax({
            url: "<?php echo e(url('umrah/fetchHotel_available_capacity')); ?>/"+brn,
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type: "GET",
            dataType: "JSON",
            success: function (data) {
...
</script><?php /**PATH D:\xampp8.2\htdocs\uotrips\resources\views/umrah/group_details/js_func.blade.php ENDPATH**/ ?>