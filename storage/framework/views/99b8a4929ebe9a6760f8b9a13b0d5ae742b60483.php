<div class="modal" id="ticket-modal">
    <div class="modal-dialog modal-xl">
        <form id="ticket-form">
            ...
            <input type="hidden" name="leadID" value="<?php echo e($result[0]->id); ?>">
            <input type="hidden" name="account_code" value="<?php echo e($result[0]->ledger); ?>">
            <div class="modal-content rounded-0">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <select name="source" class="form-control form-control-sm">
                                ...
                                <?php echo App\Models\TicketSource::dropdown(); ?>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success btn-xs" onclick="save_rec('<?php echo e(route('lead_ticket.store')); ?>','ticket-form','ticket')">Submit</button>
...
</div><?php /**PATH E:\new-projects\htdocs\uotrips\resources\views/Lms/sales/modals/ticket-modal.blade.php ENDPATH**/ ?>