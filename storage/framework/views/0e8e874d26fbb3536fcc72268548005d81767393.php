...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <button class="btn btn-primary btn-sm" type="button" onclick="save_rec()">Submit </button>
                                </div>
                            </div>
                            </form>
                        </div>
    ...
    <script>
        ...
        function get_data(page){
            $("#loader").show()
            $.ajax({
                url:"<?php echo e(url('Application_Setup/user_management/get_permission')); ?>?page="+page,
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                type:"POST",
                dataType:"JSON",
                success:function (data) {
                    ...
                    for(i in data.data){
                        ...
                        htmlData+=' <a  class="btn btn-danger btn-xs" href="javascript:void(0)" onclick="del_rec(\''+data.data[i].id+'\', \'<?php echo e(url('Application_Setup/user_management/permission/')); ?>/'+data.data[i].id+'\')"><i class="fa fa-trash"></i> </a>';
                        htmlData+='</td>';
                        htmlData+='</tr>';
                    }
        ...
        function edit(id) {
            $.ajax({
                url: "<?php echo e(url('Application_Setup/user_management/permission')); ?>/" + id + "/edit",
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                success: function (data) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp8.2\htdocs\uotrips\resources\views/permissions/index.blade.php ENDPATH**/ ?>