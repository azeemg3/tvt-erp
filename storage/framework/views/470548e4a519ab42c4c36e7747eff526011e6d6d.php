<div class="tab-pane fade" id="tour-transport" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
    <form id="tour-transport-form">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-success btn-xs" onclick="save_tour_rec('<?php echo e(url('lms/tour_transport_store')); ?>', 'tour-transport-form', 'transport')">Submit</button>
...
</div><?php /**PATH E:\new-projects\htdocs\uotrips\resources\views/Lms/sales/tours/transport.blade.php ENDPATH**/ ?>