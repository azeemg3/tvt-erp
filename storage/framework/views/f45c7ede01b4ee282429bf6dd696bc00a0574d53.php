<div class="tab-pane fade" id="tour-hotel" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
    <form id="tour-hotel-form">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-success btn-xs" onclick="save_tour_rec('<?php echo e(url('Sale/tour_hotel_store')); ?>', 'tour-hotel-form', 'hotel')">Submit</button>
...
</div><?php /**PATH D:\xampp8.2\htdocs\uotrips\resources\views/sales/tours/hotel.blade.php ENDPATH**/ ?>