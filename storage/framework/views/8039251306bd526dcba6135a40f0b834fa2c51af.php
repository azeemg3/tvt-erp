<div class="tab-pane fade" id="tour-other" role="tabpanel" aria-labelledby="custom-tabs-one-settings-tab">
    <form id="tour-other-form">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-success btn-xs" onclick="save_tour_rec('<?php echo e(url('lms/tour_other_store')); ?>', 'tour-other-form', 'other')">Submit</button>
...
</div><?php /**PATH E:\new-projects\htdocs\uotrips\resources\views/Lms/sales/tours/other.blade.php ENDPATH**/ ?>