                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <select class="form-control form-control-sm select2" name="ledger">
                        ...
                        <div class="form-group col-md-2">
                            <label>Rate</label>
                            <input type="text" onkeyup="trans_cal(this)" name="receiveable" class="form-control form-control-sm bf" placeholder="Rate">
                        </div>
                        <!--col-->
                        <div class="form-group col-md-2">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label>Psf</label>
                                                <input type="text" onkeyup="trans_cal(this)" name="psf" class="form-control form-control-sm psf" placeholder="Enter ...">
                                            </div>
                                        </div>
                                        <!--col-->
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" onkeyup="trans_cal(this)" name="discount" class="form-control form-control-sm dis" placeholder="Enter ...">
                                            </div>
                                        </div>
                                        <!--col-->
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" onkeyup="trans_cal(this)" name="agent_amount" class="form-control form-control-sm agent_amount" placeholder="Enter ...">
                                            </div>
                                        </div>
                                        <!--col-->
                                        <div class="col-sm-3">
                                ...
                                <div class="card-body" style="padding: 0.5rem;">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            ...
                                            <div class="form-group">
                                                <label>Payable</label>
                                                <input type="text" name="payable" onkeyup="trans_cal(this)" class="form-control form-control-sm payable" placeholder="0.00 %">
                                            </div>
                                        </div>
                                        <!--col-->
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Receiveable</label>
                                                <input type="text" onkeyup="trans_cal(this)" name="receiveable" class="form-control form-control-sm receiveable" placeholder="Enter ...">
                                            </div>
                                        </div>
                                        <!--col-->
                                        <div class="col-sm-4">
                                            ...
                                            <div class="form-group">
                                                <label>Profit</label>
                                                <input type="text" onkeyup="trans_cal(this)" name="profit" class="form-control form-control-sm profit" placeholder="Enter ...">
                                            </div>
                                        </div>
                                        <!--col-->
                                    </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success btn-xs" onclick="save_rec('<?php echo e(route('acc_transport.store')); ?>','transport-form','transport')">Submit</button>
...
</div><?php /**PATH D:\xampp8.2\htdocs\uotrips\resources\views/sales/modals/transport-modal.blade.php ENDPATH**/ ?>