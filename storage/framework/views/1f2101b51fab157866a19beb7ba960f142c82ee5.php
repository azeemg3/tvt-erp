...
<?php $__env->startSection('content'); ?>
    ...
    <!-- /.content-wrapper -->
    <?php echo $__env->make('booking_confirmation.hotel_confirmation.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    <script src="<?php echo e(URL::asset('public/export_excel/jquery.table2excel.js')); ?>"></script>
    <script>
        function save_rec() {
            $.ajax({
                url:"<?php echo e(route('hotel_confirimation.store')); ?>",
        ...
        function get_data(page){
            $.ajax({
                url:"<?php echo e(url('BookingConfirmation/get_hotel_confirimation')); ?>?page="+page,
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                type:"POST",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp8.2\htdocs\uotrips\resources\views/booking_confirmation/hotel_confirmation/index.blade.php ENDPATH**/ ?>