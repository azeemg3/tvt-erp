            ...
            <div class="modal-content rounded-0">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <!--col-->
                        <div class="form-group col-md-12" id="assign_products">
                            ...
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="exampleCheck1">Ticket</label>
                            </div>
                            <!--form-check-->
                            <div class="form-check form-check-inline">
...
</div><?php /**PATH D:\xampp8.2\htdocs\uotrips\resources\views/agents/subagent/modal.blade.php ENDPATH**/ ?>