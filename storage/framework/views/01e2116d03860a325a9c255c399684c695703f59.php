...
<?php $__env->startSection('content'); ?>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Subagent List</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
    ...
    <!-- /.content-wrapper -->
    <?php echo $__env->make('agents.subagent.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        ...
        function get_data(page){
            $("#loader").show();
            $.ajax({
                url:"<?php echo e(url('agent_management/get_agents')); ?>?page="+page,
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                type:"POST",
                dataType:"JSON",
                success:function (data) {
                    ...
                    for(i in data.data){
                        ...
                        htmlData+='<td>'+(data.data[i].agent_type==0?'Sub Admin':'Agent')+'</td>';
                        htmlData+='<td>'+data.data[i].agent_address+'</td>';
        ...
        function edit(id) {
            $("#new").modal();
            $.ajax({
                url: "<?php echo e(url('agent_management/agent')); ?>/" + id + "/edit",
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                success: function (data) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp8.2\htdocs\uotrips\resources\views/agents/subagent/index.blade.php ENDPATH**/ ?>