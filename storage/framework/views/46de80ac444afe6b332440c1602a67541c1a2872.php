...
<?php $__env->startSection('content'); ?>
    ...
    <!-- /.content-wrapper -->
    <?php echo $__env->make('Accounts.trans_accounts.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        ...
        function get_data(page){
            $("#loader").show();
            $.ajax({
                url:"<?php echo e(url('Accounts/get_trans_accounts')); ?>?page="+page,
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                type:"POST",
                dataType:"JSON",
