...
<?php $__env->startSection('content'); ?>
    ...
    <!-- /.content-wrapper -->
    <?php echo $__env->make('Setup.airlines.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        ...
        function save_rec() {
            $("#loader").show();
            $.ajax({
                url:"<?php echo e(route('airlines.store')); ?>",
        ...
        function get_data(page){
            $.ajax({
                url:"<?php echo e(url('Application_Setup/get_airlines')); ?>?page="+page,
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                type:"POST",
                dataType:"JSON",
                success:function (data) {
        ...
        function edit(id) {
            $("#new").modal();
            $.ajax({
                url: "<?php echo e(url('Application_Setup/airlines')); ?>/" + id + "/edit",
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                success: function (data) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp8.2\htdocs\uotrips\resources\views/Setup/airlines/index.blade.php ENDPATH**/ ?>