<div class="tab-pane fade" id="tour-visa" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
    <form id="tour-visa-form">
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm select2" name="agent_id">
                                        ...
                                        <?php echo App\Models\Accounts\TransactionAccount::dropdown(); ?>
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-success btn-xs" onclick="save_tour_rec('<?php echo e(url('Sale/tour_visa_store')); ?>', 'tour-visa-form', 'visa')">Submit</button>
...
</div><?php /**PATH D:\xampp8.2\htdocs\uotrips\resources\views/sales/tours/visa.blade.php ENDPATH**/ ?>