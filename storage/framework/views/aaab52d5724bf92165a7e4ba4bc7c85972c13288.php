...
<div class="tab-pane fade show active" id="tour-ticket" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
    <form id="tour-ticket-form">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-success btn-xs" onclick="save_tour_rec('<?php echo e(url('Sale/tour_ticket_store')); ?>','tour-ticket-form','ticket')">Submit</button>
...
</div><?php /**PATH D:\xampp8.2\htdocs\uotrips\resources\views/sales/tours/ticket.blade.php ENDPATH**/ ?>