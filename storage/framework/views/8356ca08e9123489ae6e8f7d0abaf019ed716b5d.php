<div class="modal" id="external-agent">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <select name="PID" class="form-control form-control-sm select2">
                                ...
                                <?php echo App\Models\Accounts\SubHeadAccount::dropdown(); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Code</label>
                                <input type="text" name="code" value="" class="form-control form-control-sm" placeholder="e,g 012">
                            </div>
                        </div>
                        <!--col-->
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <select name="OB_Type" class="form-control form-control-sm">
                                <?php echo App\Helpers\Account::dc(); ?>
...
</div><?php /**PATH D:\xampp8.2\htdocs\uotrips\resources\views/umrah/ground_services/external-agent-modal.blade.php ENDPATH**/ ?>