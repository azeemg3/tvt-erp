...
<?php $__env->startSection('content'); ?>
    ...
    <script>
        ...
        function get_data(page){
            $("#loader").show();
            $.ajax({
                url:"<?php echo e(url('umrah/get_hotel_reservation')); ?>?page="+page,
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                type:"POST",
                dataType:"JSON",
        ...
        function edit(id) {
            $("#hotel-reservation").modal();
            $.ajax({
                url: "<?php echo e(url('umrah/hotel_reservation')); ?>/" + id + "/edit",
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                success: function (data) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp8.2\htdocs\uotrips\resources\views/umrah/reservations/hotel_reservation/index.blade.php ENDPATH**/ ?>