<?php $__env->startSection('content'); ?>
    ...
    <!-- /.content-wrapper -->
    <?php echo $__env->make('Rate_setup.hotel_rate.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('Setup.hotels.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('Setup.hotel_rooms.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        ...
        function save_rec() {
            ...
            jq.ajax({
                url:"<?php echo e(route('hotel_rate.store')); ?>",
        ...
        function get_data(page){
            jq("#loader").show();
            jq.ajax({
                url:"<?php echo e(url('Application_Setup/Rate_Setup/get_hotel_rates')); ?>?page="+page,
                headers: {'X-CSRF-TOKEN': jq('meta[name="csrf-token"]').attr('content')},
                type:"POST",
...
//                        htmlData+='<td>'+jq.parseJSON(data.data[i].sharing_rate.replaceAll("'", '')).net_sale+'</td>';
                        ...
                        htmlData+=' <a  class="btn btn-danger btn-xs" href="javascript:void(0)" onclick="del_rec(\''+data.data[i].id+'\', \'<?php echo e(url('Application_Setup/Rate_Setup/hotel_rate')); ?>/'+data.data[i].id+'\')"><i class="fa fa-trash"></i> </a>';
                        htmlData+='</td>';
                        htmlData+='</tr>';
                    }
        ...
        function edit(id) {
            $("#new").modal();
            jq.ajax({
                url: "<?php echo e(url('Application_Setup/Rate_Setup/hotel_rate')); ?>/" + id + "/edit",
                headers: {'X-CSRF-TOKEN': jq('meta[name="csrf-token"]').attr('content')},
                success: function (data) {
...
//                        jq("#form select[name~='"+Object.keys(data.res)[i]+"']").val(Object.values(data.res)[i]);
        ...
        function save_room() {
            $("#loader").show();
            $.ajax({
                url:"<?php echo e(route('room_types.store')); ?>",
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                type:"POST",
                dataType:"JSON",
        ...
        function approved_rate() {
            ...
            $.ajax({
                url:"<?php echo e(url('Application_Setup/Rate_Setup/approve_hotel_rate')); ?>/"+id,
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                type:"GET",
                dataType:"JSON",
                success:function (data) {
