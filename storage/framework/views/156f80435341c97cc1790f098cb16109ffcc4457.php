                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php endif; ?>
                            <form action="<?php echo e(route('quarantine.store')); ?>" method="post" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-sm select2 country" name="country_id">
                                                <?php echo App\Models\Country::dropdown(old('country_id')); ?>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-sm select2 city" name="city_id">
                                                <?php echo App\Models\City::dropdown(old('city_id')); ?>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select name="airline_id" class="form-control form-control-sm select2">
                                                ...
                                                <?php echo App\Models\Airline::dropdown(old('airline_id')); ?>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="inclusions[]" class="form-control form-control-sm select2" multiple>
                                                <?php echo App\Helpers\cms::incluions(); ?>
