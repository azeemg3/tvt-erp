<?php $__env->startSection('content'); ?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form action="<?php echo e(route('tour.store')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input name="duration" value="<?php echo e(old('duraion')); ?>"  type="text" class="form-control form-control-sm" placeholder="Duration e.g total nights">
                                        </div>
                                    </div>
                                    <!--col-->
                                    <div class="col-xs-12 col-sm-12 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="traveling_dt" value="<?php echo e(old('traveling_dt')); ?>" id="reservation" class="form-control form-control-sm" placeholder="Traveling Date From">
                                        </div>
                                    </div>
                                    <!--col-->
                                    <div class="col-xs-12 col-sm-12 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="departure_details" value="<?php echo e(old('departure_details')); ?>" class="form-control form-control-sm" placeholder="Departure Date">
                                        </div>
                                    </div>
                                    <!--col-->
                                    <div class="col-xs-12 col-sm-12 col-md-3">
    ...
    <!-- /.content-wrapper -->
    <?php echo $__env->make('cms.Tours.tour.inc_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?><!-- jQuery -->

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\new-projects\htdocs\uotrips\resources\views/cms/Tours/tour/create.blade.php ENDPATH**/ ?>