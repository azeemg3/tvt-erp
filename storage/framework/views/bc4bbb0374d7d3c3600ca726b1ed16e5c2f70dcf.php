<?php $__env->startSection('content'); ?>
    ...
    <!-- /.content-wrapper -->
    <?php echo $__env->make('Rate_setup.transport_rate.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        ...
        function save_rec() {
            ...
            jq.ajax({
                url:"<?php echo e(route('transport_rate.store')); ?>",
...
//                    });
        ...
        function get_data(page){
            jq("#loader").show();
            jq.ajax({
                url:"<?php echo e(url('Application_Setup/Rate_Setup/get_transport_rates')); ?>?page="+page,
                headers: {'X-CSRF-TOKEN': jq('meta[name="csrf-token"]').attr('content')},
                type:"POST",
        ...
        function approved_rate() {
            ...
            $.ajax({
                url:"<?php echo e(url('Application_Setup/Rate_Setup/approve_transport_rate')); ?>/"+id,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp8.2\htdocs\uotrips\resources\views/Rate_setup/transport_rate/index.blade.php ENDPATH**/ ?>