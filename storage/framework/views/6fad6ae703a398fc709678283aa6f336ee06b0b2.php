<div class="tab-pane fade show active" id="tour-ticket" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
    <form id="tour-ticket-form">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-success btn-xs" onclick="save_tour_rec('<?php echo e(url('lms/tour_ticket_store')); ?>','tour-ticket-form','ticket')">Submit</button>
...
</div><?php /**PATH E:\new-projects\htdocs\uotrips\resources\views/Lms/sales/tours/ticket.blade.php ENDPATH**/ ?>