<?php $__env->startSection('content'); ?>
    ...
    <!-- /.content-wrapper -->
    <?php echo $__env->make('providors.hotels.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        ...
        function save_rec() {
            ...
            jq.ajax({
                url:"<?php echo e(route('hotel_providor.store')); ?>",
        ...
        function get_data(page){
            jq("#loader").show();
            jq.ajax({
                url:"<?php echo e(url('providors/get_hotel_providor')); ?>?page="+page,
                headers: {'X-CSRF-TOKEN': jq('meta[name="csrf-token"]').attr('content')},
                type:"POST",
