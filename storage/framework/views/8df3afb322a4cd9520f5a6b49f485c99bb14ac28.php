<div class="modal" id="tour-modal">
    <div class="modal-dialog modal-xl">
            ...
            <input type="hidden" class="leadID" name="leadID" value="<?php echo e($result[0]->id); ?>">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-md-2">
                            ...
                            <input name="inv_date" class="form-control form-control-sm date inv_date" placeholder="Invice Date">
                        </div>
                        <!--col-->
                        <div class="form-group col-md-2">
                            <label for="exampleInputEmail1">Due Date*</label>
                            <input name="due_date" class="form-control form-control-sm date due_date" placeholder="Due Date">
                        </div>
                        <!--col-->
                        <div class="form-group col-md-2">
                            ...
                            <div class="card card-primary card-outline card-outline-tabs">
                                ...
                                <div class="card-body">
                                    <div class="tab-content" id="custom-tabs-one-tabContent">
                                        <?php echo $__env->make('Lms.sales.tours.ticket', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <?php echo $__env->make('Lms.sales.tours.hotel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <?php echo $__env->make('Lms.sales.tours.visa', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <?php echo $__env->make('Lms.sales.tours.transport', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <?php echo $__env->make('Lms.sales.tours.other', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
                                </div>
                                <!-- /.card -->
                            </div>
...
<?php echo $__env->make('Lms.sales.modals.tour_pax_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\new-projects\htdocs\uotrips\resources\views/Lms/sales/modals/tour-modal.blade.php ENDPATH**/ ?>