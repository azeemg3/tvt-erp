    ...
    <form id="tour-visa-form">
        ...
        <input type="hidden" name="account_code" value="<?php echo e($result[0]->ledger); ?>">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success btn-xs" onclick="save_tour_rec('<?php echo e(url('lms/tour_visa_store')); ?>', 'tour-visa-form', 'visa')">Submit</button>
...
</div><?php /**PATH E:\new-projects\htdocs\uotrips\resources\views/Lms/sales/tours/visa.blade.php ENDPATH**/ ?>