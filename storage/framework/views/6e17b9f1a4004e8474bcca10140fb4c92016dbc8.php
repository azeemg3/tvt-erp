...
<?php $__env->startSection('content'); ?>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Agent Wallet</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
    ...
    <!-- /.content-wrapper -->
    <?php echo $__env->make('agents.agent_wallet.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        ...
        function save_rec() {
            $("#loader").show();
            $.ajax({
                url:"<?php echo e(route('agent_wallet.store')); ?>",
                ...
                success:function (data) {
                    ...
                    $.each(vali, function( index, value ) {
                        ...
                        $("#form textarea[name~='" + index + "']").css('border', '1px solid red');
                        toastr.error(value);
                    });
                    $("#loader").hide();
                }
        ...
        function get_data(page){
            $("#loader").show();
            $.ajax({
                url:"<?php echo e(url('agent_management/get_agent_wallet')); ?>?page="+page,
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                type:"POST",
                dataType:"JSON",
                success:function (data) {
        ...
        function edit(id) {
            $("#new").modal();
            $.ajax({
                url: "<?php echo e(url('agent_management/agent_wallet')); ?>/" + id + "/edit",
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                success: function (data) {
