...
@section('content')
                ...
                <div class="col-12">
                    <div class="card rounded-0">
                        ...
                        <div class="card-body">
                            ...
                            {!! \App\Helpers\CommonHelper::print_header('Checkin Report') !!}
    ...
    <script>
        ...
        function get_data(page){
            ...
            $.ajax({
                url:"{{ url('reports/umrah/get_checkin_report') }}?page="+page,
        ...
        jq(document).ready(function(){
            $(".exportToExcel").click(function () {
                jq("#table2excel").table2excel({
                    ...
                    filename: "checkin_report" + new Date().toISOString().replace(/[\-\:\.]/g, "") + ".xls",
                    fileext: ".xls",
                    exclude_img: true,
                    exclude_links: true,
                    exclude_inputs: true,
