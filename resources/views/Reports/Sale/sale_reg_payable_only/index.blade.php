...
@section('content')
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Sale Register Payable Only</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div id="report-area">
                                ...
                                <div class="sale-report-header report-show">
                                    ...
                                    <div class="sale-report-vendor report-show" id="vendor_label"></div>
                                    <div class="sale-report-title">Sale Register Payable Only</div>
    ...
    <script>
        ...
        function get_data(page) {
            ...
            $.ajax({
                url: "{{ url('reports/sale/get_sale_reg_payable_only') }}?page=" + page,
                ...
                success: function (data) {
                    ...
                    if (data.vendor_name) {
                        $('#vendor_label').text(data.vendor_name);
                    } else {
                        $('#vendor_label').text('');
                    }
        ...
        function emailReport() {
            var subject = encodeURIComponent('Sale Register Payable Only - {{ $company->name }}');
            var body = encodeURIComponent('Please find the Sale Register Payable Only report attached.\n\nFrom: ' + $('#display_from').text() + '\nTo: ' + $('#display_to').text());
        ...
        jq(document).ready(function () {
            jq(".exportToExcel").click(function () {
                jq("#table2excel").table2excel({
                    exclude: ".noExl",
                    name: "Sale Register Payable Only",
                    filename: "sale_reg_payable_only_" + new Date().toISOString().replace(/[\-\:\.]/g, "") + ".xls",
                    fileext: ".xls",
                    exclude_img: true,
                    exclude_links: true,
                    exclude_inputs: true,
            ...
            jq(".exportToWord").click(function () {
                ...
                link.download = 'sale_reg_payable_only_' + new Date().toISOString().slice(0, 10) + '.doc';
                link.click();
            });
        });
    </script>
