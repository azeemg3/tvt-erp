...
@section('content')
    ...
    <!-- /.content-wrapper -->
    @include('booking_confirmation.transport_confirmation.modal')
    ...
    <script>
        ...
        function save_rec() {
            $.ajax({
                url:"{{ route('transport_confirimation.store') }}",
        ...
        function get_data(page){
            $.ajax({
                url:"{{ url('BookingConfirmation/get_transport_confirimation') }}?page="+page,
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                type:"POST",
                ...
                success:function (data) {
                    ...
                    for(i in data.data){
                        ...
                        @can('transport_confirmation_create')
