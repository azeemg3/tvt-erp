...
@section('content')
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-3">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <select name="group_no" class="form-control form-control-sm select2 agent_group" onchange="fetch_agent_visitors(this)">
                                                                                            ...
                                                                                            {!! App\Models\Umrah\GroupDetail::dropdown() !!}
                                                                                        </select>
                                                                                    </div>
                                                                                </div>
                                                                                <!--col-->
                                                                                <div class="col-md-2">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" class="form-control form-control-sm" id="conversion_rate" name="conversion_rate" value="{{ $conversion_rate }}">
                                                                                    </div>
                                                                                </div>
                                                                                <!--col-->
                                                                            </div>
                                                                                                ...
                                                                                                <div class="col-md-2">
                                                                                                    <div class="form-group">
                                                                                                        ...
                                                                                                        <select class="form-control form-control-sm select2" onchange="ground_service(this.value)" name="ground_handle_product">
                                                                                                            ...
                                                                                                            {!! \App\Models\Crm\GroundHandleRate::dropdown() !!}
                                                                                                        </select>
                                                                                                    </div>
                                                                                                </div><!--col-->
                                                                                                <div class="col-md-2">
    ...
    @include('agents.agent_booking.search-transport-option-modal')
    @include('agents.agent_booking.search-hotel-option-modal')
@endsection