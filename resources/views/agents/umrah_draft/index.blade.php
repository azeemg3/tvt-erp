...
@section('content')
    ...
    <script>
        ...
        function get_data(page){
            $("#loader").show();
            $.ajax({
                url:"{{ url('agent_management/get_umrah_draft') }}?page="+page,
                ...
                success:function (data) {
                    ...
                    for(i in data.data){
                        ...
                        htmlData += '<td>';
                        htmlData += '<a  class="btn btn-primary btn-xs" href="{{ url('agent_management/agent_umrah/') }}/'+data.data[i].id+'/edit"><i class="fa fa-eye"></i> View</a>';
                        htmlData += '</td>';
                        htmlData += '</tr>';
                    }
