...
@section('content')
    ...
    <!-- /.content-wrapper -->
    @include('agents.agent_wallet.modal')
    ...
    <script>
        ...
        function get_data(page){
            $("#loader").show();
            $.ajax({
                url:"{{ url('agent_management/get_agent_wallet') }}?page="+page,
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                type:"POST",
                dataType:"JSON",
                success:function (data) {
        ...
        function edit(id) {
            $("#new").modal();
            $.ajax({
                url: "{{ url('agent_management/agent_wallet') }}/" + id + "/edit",
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                success: function (data) {
