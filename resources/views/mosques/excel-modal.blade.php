        ...
        <form id="form-excel">
            ...
            <div class="modal-content rounded-0">
                ...
                <div class="modal-header rounded-0 bg-gradient-warning">
                    <h5 class="modal-title">Import Mosques in Excel
                        <a href="{{ URL::asset('public/excel_sample/mosques.xlsx') }}" download class="btn btn-xs" download>Download Sample <i class="fa fa-file-download"></i> </a></h5>
                </div>
                <!-- Modal body -->
