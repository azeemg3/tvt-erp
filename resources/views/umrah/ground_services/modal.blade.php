                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="start_date" class="form-control form-control-sm date" placeholder="{{ date('Y-m-d') }}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>End Date<span class="text-danger">*</span></label>
                                <input type="text" name="end_date" class="form-control form-control-sm date" placeholder="{{ date('Y-m-d') }}">
                            </div>
                        </div>
                        <!--col-->
                        <div class="col-md-3">
...
@include('umrah.ground_services.select-mutamer-modal')
@include('umrah.ground_services.external-agent-modal')