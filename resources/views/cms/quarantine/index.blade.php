...
@section('content')
                ...
                <div class="col-12">
                    <div class="card rounded-0">
                        ...
                        <div class="card-body">
                            ...
                            <a class="btn btn-xs btn-dark float-right" href="{{ route('quarantine.create') }}">Add New</a>
    ...
    <script>
        ...
        function get_data(page){
            $("#loader").show();
            $.ajax({
                url:"{{ url('cms/get_quarantine') }}?page="+page,
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                type:"POST",
                dataType:"JSON",
                success:function (data) {
                    ...
                    for(i in data.data){
                        ...
                        htmlData+='<td>';
                        htmlData += '<a href="{{ url('cms/quarantine') }}/'+data.data[i].id+'/edit"  class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> </a>';
