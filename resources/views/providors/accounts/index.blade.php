...
@section('content')
                    ...
                    <div class="card rounded-0">
                        ...
                        <div class="card-body">
                            <form id="form">
                                <div class="row">
                                    <div class="col-md-2">
                                        <input name="df" class="form-control form-control-sm date" placeholder="Date From" value="{{ date('Y-m-01') }}">
                                    </div>
                                    <div class="col-md-2">
                                        <input name="dt" class="form-control form-control-sm date" placeholder="Date To" value="{{ date('Y-m-t') }}">
                                    </div>
                                    <div class="col-sm-1">
    ...
    <script>
        ...
        function get_data(){
            $("#loader").show();
            $.ajax({
                url:"{{ url('providors/accounts/get_account_statement') }}",
