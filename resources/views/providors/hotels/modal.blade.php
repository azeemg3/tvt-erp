                    ...
                    <div class="row">
                        <div class="col-md-12" id="room_type">
                            ...
                            <div class="row">
                                ...
                                {{--<div style="position: absolute; right: 15px;top:57px;">--}}
                                    {{--<button type="button" class="btn btn-xs btn-primary" onclick="more_item(this)"><i class="fa fa-plus"></i> </button>--}}
                                {{--</div>--}}
                            </div>
                            <!--row-->
                            <div class="row day_rate">
                                @for($i=1; $i<=31; $i++)
                                    <div class="form-group col-md-1">
                                        <label>{{ $i }}</label>
                                        <input type="text" name="validity_date_rate[{{ $i }}]" class="form-control form-control-sm single_bed_rate validity_date_rate{{ $i }}" placeholder="Enter">
                                    </div>
                                    @endfor
                            </div>
                        </div>
