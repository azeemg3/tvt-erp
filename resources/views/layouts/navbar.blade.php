...
<nav class="main-header navbar navbar-expand navbar-info navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('modules.index') }}" class="nav-link" style="color: white" title="Switch module">
                <i class="fas fa-th-large mr-1"></i> Modules
                @isset($activeModule)
                    @if($activeModule)
                        <span class="badge badge-light ml-1">{{ $activeModule['label'] }}</span>
                    @endif
                @endisset
            </a>
        </li>
