<div class="tab-pane fade show active" id="ticket" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
    ...
    <button type="button" onclick="add_new_sale('ticket-modal')" class="btn btn-primary btn-xs btn-flat float-right mb-2">Add New</button>
    <div class="table-responsive">
    <table id="ticket-sale-table" class="table table-bordered table-striped sale-data-table w-100">
        <thead>
...
@include('sales.modals.ticket-modal')