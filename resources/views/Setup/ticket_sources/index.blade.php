...
@section('content')
    ...
    <!-- /.content-wrapper -->
    @include('Setup.ticket_sources.modal')
    ...
    <script>
        ...
        function get_data(page){
            $.ajax({
                url:"{{ url('Application_Setup/get_ticket_source') }}?page="+page,
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                type:"POST",
                dataType:"JSON",
                success:function (data) {
        ...
        function edit(id) {
            $("#new").modal();
            $.ajax({
                url: "{{ url('Application_Setup/ticket_source') }}/" + id + "/edit",
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                success: function (data) {
